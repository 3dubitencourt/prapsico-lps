...
import { OFFER_ANCHOR, OFFER_INCLUDES } from "./constants";
        ...
        <div className="rounded-3xl bg-navy-950 border-2 border-cyan/40 p-6 md:p-9 shadow-[0_24px_60px_rgba(6,164,212,0.18)]">
          <div className="text-center mb-5">
            ...
            <p className="text-sm md:text-base text-muted">
              12 meses · EAD · Reconhecido pelo MEC
            </p>
          </div>
          ...
          <div className="text-center my-6">
            ...
            <p className="font-bold leading-none">
              ...
              <span className="text-5xl md:text-7xl text-ink mx-1">257</span>
              <span className="text-lg md:text-xl text-muted">/mês</span>
            </p>
            <p className="mt-2.5 text-xs md:text-sm text-subtle">
              ou à vista · pagamento seguro via Voomp Creators
            </p>
          </div>
          ...
          <ul className="space-y-2.5 mb-7 max-w-md mx-auto">
            {OFFER_INCLUDES.map((item) => (
              <li key={item} className="flex items-start gap-3">
                ...
                <span className="text-sm md:text-base text-ink/95 leading-relaxed">
                  {item}
                </span>
              </li>
            ))}
